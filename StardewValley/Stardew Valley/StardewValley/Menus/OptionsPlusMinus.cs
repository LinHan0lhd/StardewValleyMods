...
namespace StardewValley.Menus
{
	...
	{
		// Token: 0x06002B46 RID: 11078 RVA: 0x0020BA8C File Offset: 0x00209C8C
		public OptionsPlusMinus(string label, int whichOption, List<string> options, List<string> displayOptions, int x = -1, int y = -1) : base(label, x, y, 28, 28, whichOption)
		{
			...
			this.bounds = new Rectangle(x, y, 56 + txtSize, 32);
			this.label = label;
		...
		// Token: 0x06002B47 RID: 11079 RVA: 0x0020BBB4 File Offset: 0x00209DB4
		...
		// Token: 0x06002B48 RID: 11080 RVA: 0x0020BCD4 File Offset: 0x00209ED4
		...
		// Token: 0x06002B49 RID: 11081 RVA: 0x0020BD80 File Offset: 0x00209F80
		public override void draw(SpriteBatch b, int slotX, int slotY, IClickableMenu context = null)
		{
			b.Draw(Game1.mouseCursors, new Vector2((float)(slotX + this.minusButton.X), (float)(slotY + this.minusButton.Y)), new Rectangle?(OptionsPlusMinus.minusButtonSource), Color.White * (this.greyedOut ? 0.33f : 1f) * ((this.selected == 0) ? 0.5f : 1f), 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.4f);
			...
			b.Draw(Game1.mouseCursors, new Vector2((float)(slotX + this.plusButton.X), (float)(slotY + this.plusButton.Y)), new Rectangle?(OptionsPlusMinus.plusButtonSource), Color.White * (this.greyedOut ? 0.33f : 1f) * ((this.selected == this.displayOptions.Count - 1) ? 0.5f : 1f), 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.4f);
			if (!Game1.options.snappyMenus && Game1.options.gamepadControls)
			{
