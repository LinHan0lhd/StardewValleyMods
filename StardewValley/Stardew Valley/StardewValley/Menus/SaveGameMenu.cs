...
namespace StardewValley.Menus
{
	...
	{
		// Token: 0x06002C23 RID: 11299 RVA: 0x0021AAE4 File Offset: 0x00218CE4
		public SaveGameMenu()
		{
		...
		// Token: 0x06002C24 RID: 11300 RVA: 0x0021AB74 File Offset: 0x00218D74
		...
		// Token: 0x06002C25 RID: 11301 RVA: 0x0021ABDB File Offset: 0x00218DDB
		public override bool readyToClose()
		{
			return false;
		}

		// Token: 0x06002C26 RID: 11302 RVA: 0x0021ABE0 File Offset: 0x00218DE0
		...
		// Token: 0x06002C27 RID: 11303 RVA: 0x0021AE62 File Offset: 0x00219062
		...
		// Token: 0x06002C28 RID: 11304 RVA: 0x0021AE84 File Offset: 0x00219084
		public override void draw(SpriteBatch b)
		{
			base.draw(b);
			Vector2 txtpos = new Vector2(64f, (float)(Game1.uiViewport.Height - 64));
			...
			else if (this.margin < 0 || Game1.IsClient)
			{
				...
				{
					int totalPlayers = Game1.getOnlineFarmers().Count - ((Game1.HasDedicatedHost > false) ? 1 : 0);
		...
		// Token: 0x06002C29 RID: 11305 RVA: 0x0021B10E File Offset: 0x0021930E
		public void Dispose()
		{
			Game1.game1.IsSaving = false;
		}
