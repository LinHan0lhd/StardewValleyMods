...
namespace StardewValley.Minigames
{
	...
	{
		// Token: 0x0600269E RID: 9886 RVA: 0x001B5DF8 File Offset: 0x001B3FF8
		public TargetGame()
		{
			TargetGame.score = 0;
			...
			Tool slingshot = ItemRegistry.Create<Tool>("(W)32", 1, 0, false);
			slingshot.attachments[0] = ItemRegistry.Create<Object>("(O)390", 999, 0, false);
		...
		// Token: 0x0600269F RID: 9887 RVA: 0x001B5EF5 File Offset: 0x001B40F5
		public bool overrideFreeMouseMovement()
		{
			return false;
		}

		// Token: 0x060026A0 RID: 9888 RVA: 0x001B5EF8 File Offset: 0x001B40F8
		public bool tick(GameTime time)
		{
			...
			else if (!this.gameDone)
			{
				...
				this.targets.RemoveAll((TargetGame.Target target) => target.update(time, this.location));
			}
		...
		// Token: 0x060026A1 RID: 9889 RVA: 0x001B6370 File Offset: 0x001B4570
		...
		// Token: 0x060026A2 RID: 9890 RVA: 0x001B6430 File Offset: 0x001B4630
		...
		// Token: 0x060026A3 RID: 9891 RVA: 0x001B64F9 File Offset: 0x001B46F9
		public void leftClickHeld(int x, int y)
		{
		}

		// Token: 0x060026A4 RID: 9892 RVA: 0x001B64FB File Offset: 0x001B46FB
		public void receiveRightClick(int x, int y, bool playSound = true)
		{
		}

		// Token: 0x060026A5 RID: 9893 RVA: 0x001B6500 File Offset: 0x001B4700
		...
		// Token: 0x060026A6 RID: 9894 RVA: 0x001B65AB File Offset: 0x001B47AB
		public void releaseRightClick(int x, int y)
		{
		}

		// Token: 0x060026A7 RID: 9895 RVA: 0x001B65B0 File Offset: 0x001B47B0
		...
		// Token: 0x060026A8 RID: 9896 RVA: 0x001B66E8 File Offset: 0x001B48E8
		...
		// Token: 0x060026A9 RID: 9897 RVA: 0x001B67A4 File Offset: 0x001B49A4
		public void draw(SpriteBatch b)
		{
			if (this.showResultsTimer < 0)
			{
				...
				{
					Game1.drawWithBorder(Game1.content.LoadString("Strings\\StringsFromCSFiles:TargetGame.cs.12154", (int)(Math.Round((double)((float)TargetGame.successShots / (float)(TargetGame.shotsFired - 1)), 2) * 100.0)), Color.Black, Color.White, new Vector2(32f, 96f));
				}
				b.End();
				return;
			}
			...
			if (this.showResultsTimer <= 9000)
			{
				...
				if (TargetGame.starTokensWon > 0)
				{
					...
					Game1.drawWithBorder(Game1.content.LoadString("Strings\\StringsFromCSFiles:FishingGame.cs.12013", TargetGame.starTokensWon), Game1.textColor * 0.2f * fade, Color.SkyBlue * 0.3f * fade, position + new Vector2((float)Game1.random.Next(-1, 2), (float)Game1.random.Next(-1, 2)) * 4f * 2f, 0f, 1f, 1f);
					Game1.drawWithBorder(Game1.content.LoadString("Strings\\StringsFromCSFiles:FishingGame.cs.12013", TargetGame.starTokensWon), Game1.textColor * 0.2f * fade, Color.SkyBlue * 0.3f * fade, position + new Vector2((float)Game1.random.Next(-1, 2), (float)Game1.random.Next(-1, 2)) * 4f * 2f, 0f, 1f, 1f);
					Game1.drawWithBorder(Game1.content.LoadString("Strings\\StringsFromCSFiles:FishingGame.cs.12013", TargetGame.starTokensWon), Game1.textColor * 0.2f * fade, Color.SkyBlue * 0.3f * fade, position + new Vector2((float)Game1.random.Next(-1, 2), (float)Game1.random.Next(-1, 2)) * 4f * 2f, 0f, 1f, 1f);
		...
		// Token: 0x060026AA RID: 9898 RVA: 0x001B7010 File Offset: 0x001B5210
		...
		// Token: 0x060026AB RID: 9899 RVA: 0x001B7028 File Offset: 0x001B5228
		...
		// Token: 0x060026AC RID: 9900 RVA: 0x001B70A3 File Offset: 0x001B52A3
		public void unload()
		{
		...
		// Token: 0x060026AD RID: 9901 RVA: 0x001B70D4 File Offset: 0x001B52D4
		...
		// Token: 0x060026AE RID: 9902 RVA: 0x001B72D0 File Offset: 0x001B54D0
		...
		// Token: 0x060026AF RID: 9903 RVA: 0x001B7374 File Offset: 0x001B5574
		...
		// Token: 0x060026B0 RID: 9904 RVA: 0x001B73AC File Offset: 0x001B55AC
		public void receiveEventPoke(int data)
		{
		}

		// Token: 0x060026B1 RID: 9905 RVA: 0x001B73AE File Offset: 0x001B55AE
		public string minigameId()
		{
			return "TargetGame";
		}

		// Token: 0x060026B2 RID: 9906 RVA: 0x001B73B5 File Offset: 0x001B55B5
		public bool doMainGameUpdates()
		{
			return false;
		}

		// Token: 0x060026B3 RID: 9907 RVA: 0x001B73B8 File Offset: 0x001B55B8
		...
		public class Target
		{
			// Token: 0x0600432C RID: 17196 RVA: 0x003187F8 File Offset: 0x003169F8
			...
			// Token: 0x0600432D RID: 17197 RVA: 0x00318880 File Offset: 0x00316A80
			...
			// Token: 0x0600432E RID: 17198 RVA: 0x003189C4 File Offset: 0x00316BC4
			public void shatter(GameLocation location, Projectile stone)
			{
				...
				{
					Game1.playSound("potterySmash", null);
					scoreToAdd += 2;
				}
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(304, 1183 + this.targetType * 16, 16, 16), 60f, 3, 0, new Vector2((float)(this.Position.X - 4), (float)(this.Position.Y - 4)), false, false, 1f, 0f, Color.White, 4f, 0f, 0f, 0f, false));
				...
				if (projectile != null && projectile.damageToFarmer.Value > 0)
				{
			...
			// Token: 0x0600432F RID: 17199 RVA: 0x00318B4C File Offset: 0x00316D4C
			public void draw(SpriteBatch b)
			{
				if (this.spawned)
				{
					b.Draw(Game1.shadowTexture, Game1.GlobalToLocal(Game1.viewport, new Vector2((float)this.Position.X, (float)(this.Position.Bottom + 32))), new Microsoft.Xna.Framework.Rectangle?(Game1.shadowTexture.Bounds), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0001f);
